...
exports.safeStringToNumber = safeStringToNumber;
exports.stringToNumberOrNull = stringToNumberOrNull;
exports.stringToNumberOrDefault = stringToNumberOrDefault;
/**
 ...
 * ```
 */
function safeStringToNumber(input, options = {}) {
    const { allowDecimals = true, allowNegative = true, min, max, defaultValue, allowScientific = true, allowWhitespace = true, allowThousandSeparators = false } = options;
 ...
 */
function stringToNumberOrNull(input, options = {}) {
 ...
 */
function stringToNumberOrDefault(input, defaultValue, options = {}) {
    var _a;
    const result = safeStringToNumber(input, Object.assign(Object.assign({}, options), { defaultValue }));
    return (_a = result.value) !== null && _a !== void 0 ? _a : defaultValue;
}
